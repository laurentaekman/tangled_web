...
const Home: NextPage = () => {
  ...
  //Callback passed into infinite scroll hook to handle object indices and page number
  ...
  /*
  Ref inserted at bottom of page—-IntersectionObserver fires when user 
  is within a certain range and custom hook fires callback
  */
